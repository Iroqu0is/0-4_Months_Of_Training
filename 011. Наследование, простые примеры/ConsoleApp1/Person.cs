namespace ConsoleApp1
{
    ...
    public class Person : ICloneable, IEquatable<Person>, IComparable<Person>, IComparer<Person>
    {
        ...
        private string fname;// поля были изначально protected, после замечания поменял private, и добавил сеттер в свойсва (раньше их там небыло)
        ...
        protected Person(Person person) : this(person.fname, person.lname, person.age) { } // этот конструктор добавлен после замечания
